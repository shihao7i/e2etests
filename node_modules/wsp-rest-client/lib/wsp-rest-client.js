...
// $Revision:  $
//
// (C) Polycom, Inc. 2015. All Rights Reserved
    ...
    var _private_APIs = {
        "authenticate": {
            opts: {
                path: "/wsp/auth/login",
                headers: {
                    "content-type": "application/vnd.com.polycom.cloudaxis.userauth+json"
                }
            },
        ...
        "getWSPExternalUrl": {
            opts: {
                ...
                headers: {
                    "content-type": "application/vnd.com.polycom.cloudAxis.rpinfra+json",
                    "X-CA-Token": "",
                    "X-CA-UserName": ""
                }
            },
        ...
        "createWSPUser": {
            opts: {
                ...
                headers: {
                    "X-CA-UserName": "",
                    "X-CA-Token": "",
                    "Content-Type": "application/vnd.com.polycom.cloudAxis.user+json",
                    "Accept": "application/vnd.com.polycom.cloudAxis.user+json"
                }
            },
        ...
        "resetUserPassword": {
            opts: {
                ...
                headers: {
                    "X-CA-UserName": "",
                    "X-CA-Token": "",
                    "Content-Type": "application/vnd.com.polycom.cloudaxis.changepassword+json"
                }
            },
            params: ["newPassword"],
            method: "post"
        ...
        "createConference": {
            opts: {
                ...
                headers: {
                    "X-CA-UserName": "",
                    "X-CA-Token": "",
                    "Accept": "application/vnd.com.polycom.cloudAxis.conference+json",
                    "Content-Type": "application/vnd.com.polycom.cloudAxis.conference+json"
                }
            },
...
var wspHelpers = {
    getWSPAuthAgentInfo: function(jsonFile) {
        var agenttype = "wsp-authentication/polycom.mea.agent.wsp-authentication",
